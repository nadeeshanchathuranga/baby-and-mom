  ...
  public function submit(Request $request)
{
    ...
    $validated = $request->validate([
        ...
        'customer.contactNumber' => 'nullable|string|max:30', // relaxed to allow cc+number
    ...
    // Validate products, resolve prices, and accumulate totals
    $totalAmount = 0.0;
    $totalCost = 0.0;
    ...
    // Calculate discounts (product-level + coupon + custom)
    ...
    $totalDiscount  = $productDiscounts + $couponDiscount + $customDiscount;

    DB::beginTransaction();
    try {
        // ✅ robust customer upsert
        $customer = null;
        ...
        // Create sale items & stock transactions
        foreach ($products as $p) {
            $productModel = Product::find($p['id']);
            ...
            $newStock = $productModel->stock_quantity - $qty;
