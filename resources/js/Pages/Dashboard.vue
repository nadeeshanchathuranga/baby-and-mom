  ...
  <div class="flex flex-col items-center justify-start min-h-screen py-8 space-y-8 bg-gray-100 md:px-36 px-16">
    ...
    <div class="grid w-full h-full md:grid-cols-4 grid-cols-1 gap-8 auto-rows-fr">
      ...
      <div class="dashboard-card bg-[#FFBF00]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/history.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
      ...
      <div class="dashboard-card bg-[#1AA260]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/expenses.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
      ...
      <div class="dashboard-card bg-[#FF1744]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/coupons.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
      ...
      <div class="dashboard-card bg-[#76e02f]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/building.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
      ...
      <div class="dashboard-card bg-[#e02f82]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/employee.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
      ...
      <div class="dashboard-card bg-[#216b85]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/quote.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
      ...
      <div class="dashboard-card bg-[#216b85]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/bu.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
      ...
      <div class="dashboard-card bg-[#006181]">
        <div class="card-content">
          <div class="icon-container">
            <img src="/images/dashboard/grn.png" class="icon" alt="dresshub.lk" />
          </div>
          <div class="text-container">
            <p class="title">GRN</p>
            <p class="description">
